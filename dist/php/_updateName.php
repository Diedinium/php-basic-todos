...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!isset($_POST['firstName']) || !isset($_POST['lastName'])) {
        dieWithError("Something went wrong, first name or last name were not passed", "pages/settings.php?tab=name-tab");
    }
    else {
        ...
        try {
            ...
            header("Location: ../pages/settings.php?tab=name-tab");
        }
        catch (Exception $ex) {
            dieWithError($ex->getMessage(), "pages/settings.php?tab=name-tab");
        }
    }
}
else {
